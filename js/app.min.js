  ...
  if (
    ...
    [].forEach.call(n, function(e) {
      e.addEventListener(
        ...
        function(t) {
          t.preventDefault();
          var n = document.querySelector(".landing__section"),
    ...
    return (function e(t, n, o) {
    ...
    })(
      {
            ...
            t.exports = function(e) {
              e.lines.forEach(function(e) {
                e.children.forEach(function(t) {
                  "flex-start" === t.alignSelf
                    ? (t.crossStart = e.crossStart)
                    : "flex-end" === t.alignSelf
                      ? (t.crossStart = e.crossStart + e.cross - t.crossAround)
                      : "center" === t.alignSelf
                        ? (t.crossStart =
                            e.crossStart + (e.cross - t.crossAround) / 2)
                        : "stretch" === t.alignSelf &&
                          ((t.crossStart = e.crossStart),
                          (t.crossAround = e.cross));
                });
              });
            };
          },
              ...
              if (e.mainSpace > 0) {
                ...
                t > 0 &&
                  (e.children.forEach(function(n) {
                    n.mainAround += (n.flexGrow / t) * e.mainSpace;
                  }),
                  (e.main = e.children.reduce(function(e, t) {
          ...
          function(e, t, n) {
            t.exports = function(e) {
              if (e.mainSpace < 0) {
                ...
                t > 0 &&
                  (e.children.forEach(function(n) {
                    n.mainAround += (n.flexShrink / t) * e.mainSpace;
                  }),
                  (e.main = e.children.reduce(function(e, t) {
                    return e + t.mainAround;
                  }, 0)),
            ...
            t.exports = function(e) {
              ...
              (e.lines = [(t = { main: 0, cross: 0, children: [] })]),
                e.children.forEach(function(n) {
                  "nowrap" === e.flexWrap ||
                  0 === t.children.length ||
                  e.mainAround >= t.main + n.mainAround
                    ? ((t.main += n.mainAround),
                      (t.cross = Math.max(t.cross, n.crossAround)))
                    : e.lines.push(
                        (t = {
                          main: n.mainAround,
                          cross: n.crossAround,
        ...
        7: [
          function(e, t, n) {
            t.exports = function(n) {
              return (
                n.descendants.forEach(function(e) {
                  t.exports(e);
                }),
                "flex" !== n.display
                  ? n
                  : (n.children.forEach(function(t) {
                      e("./flex-direction")(t, n.flexDirection, n.alignItems);
                    }),
                    e("./order")(n),
                    e("./flex-direction")(n, n.flexDirection, n.alignItems),
                    e("./flexbox-lines")(n),
                    "auto" === n.main &&
                      ((n.main = Math.max(
                        n.mainAround,
                        n.lines.reduce(function(e, t) {
                          return Math.max(e, t.main);
                        }, 0)
                      )),
                      "row" === n.flexDirection
                        ? (n.mainAround =
                            n.mainClient + n.mainBefore + n.mainAfter)
                        : (n.mainAround = n.main + n.mainBefore + n.mainAfter)),
                    "auto" === n.cross
                      ? ((n.cross = n.lines.reduce(function(e, t) {
                          return e + t.cross;
                        }, 0)),
                        "column" === n.flexDirection
                          ? (n.crossAround =
                              n.crossClient + n.crossBefore + n.crossAfter)
                          : (n.crossAround =
                              n.cross + n.crossBefore + n.crossAfter),
                        (n.crossSpace = n.crossAround - n.cross))
                      : (n.crossSpace =
                          n.cross -
                          n.lines.reduce(function(e, t) {
                            return e + t.cross;
                    ...
                    n.lines.forEach(function(t) {
                      (t.mainSpace = n.main - t.main),
                        e("./flex-grow")(t),
                        e("./flex-shrink")(t),
                        e("./margin-main")(t),
                        e("./margin-cross")(t),
                        e("./justify-content")(t, n.justifyContent);
                    }),
                    e("./align-items")(n),
                    n)
              );
        ...
        9: [
          function(e, t, n) {
            t.exports = function(e) {
              e.children.forEach(function(t) {
                var n = 0;
                "auto" === t.crossBefore && ++n, "auto" === t.crossAfter && ++n;
                var o = e.cross - t.crossAround;
                "auto" === t.crossBefore &&
                  ((t.crossBefore = o / n), (t.crossAround += t.crossBefore)),
                  "auto" === t.crossAfter &&
                    ((t.crossAfter = o / n), (t.crossAround += t.crossAfter));
              });
            };
          },
          {}
        ...
        10: [
          function(e, t, n) {
            t.exports = function(e) {
              var t = 0;
              e.children.forEach(function(e) {
                "auto" === e.mainBefore && ++t, "auto" === e.mainAfter && ++t;
              }),
                t > 0 &&
                  (e.children.forEach(function(n) {
                    "auto" === n.mainBefore &&
                      ((n.mainBefore = e.mainSpace / t),
                      (n.mainAround += n.mainBefore)),
                      "auto" === n.mainAfter &&
                        ((n.mainAfter = e.mainSpace / t),
                        (n.mainAround += n.mainAfter));
                  }),
                  (e.mainSpace = 0));
            };
          },
        ...
        13: [
          function(e, t, n) {
            (t.exports = function(e) {
              var n = t.exports.walk(e),
                o = t.exports.flexbox(n);
              return t.exports.write(o);
            }),
              (t.exports.flexbox = e("./flexbox")),
              (t.exports.getFlexStyles = e("./getFlexStyles")),
              (t.exports.walk = e("./walk")),
              (t.exports.write = e("./write"));
          },
          { "./flexbox": 7, "./getFlexStyles": 12, "./walk": 14, "./write": 15 }
        ],
        14: [
          function(e, t, n) {
            var o = e("../getFlexStyles");
            t.exports = function(e, n, r) {
              var i = /(^|;)\s*display\s*:\s*(inline-)?flex\s*(;|$)/i.test(
                  e.getAttribute("data-flex")
                ),
                s = { node: e, children: [], descendants: [] };
              return (
                i && void 0 !== n && n.descendants.push(s),
                (!i && n) || (n = s),
                Array.prototype.forEach.call(e.childNodes, function(o) {
                  if (i && 3 === o.nodeType && o.nodeValue.trim()) {
                    var r = o;
                    (o = e.insertBefore(
            ...
            t.exports = function(e) {
              if (
                ...
                "mainStart" in e
                  ? ((n.position = "absolute"),
                    "inline" === e.mainAxis
                      ? ((n.left = e.mainStart + "px"),
                        (n.top = e.crossStart + "px"),
                        (n.marginTop = e.crossBefore + "px"),
                        (n.marginRight = e.mainAfter + "px"),
                        (n.marginBottom = e.crossAfter + "px"),
                        (n.marginLeft = e.mainBefore + "px"))
                      : ((n.left = e.crossStart + "px"),
                        (n.top = e.mainStart + "px"),
                        (n.marginTop = e.mainBefore + "px"),
                        (n.marginRight = e.crossAfter + "px"),
                        (n.marginBottom = e.mainAfter + "px"),
                        (n.marginLeft = e.crossBefore + "px")),
                    "inline" === e.mainAxis
                      ? ((n.width =
                          e.mainAround - e.mainBefore - e.mainAfter + "px"),
                        (n.height =
                          e.crossAround - e.crossBefore - e.crossAfter + "px"))
                      : ("auto" === e.cross
                          ? (n.width =
                              e.crossClient -
                              e.crossBefore -
                        ...
                        "auto" === e.main
                          ? (n.height =
                              e.mainClient - e.mainBefore - e.mainAfter + "px")
                          : (n.height =
                              e.mainAround -
                              e.mainBefore -
                              e.mainAfter +
      ...
      var i,
        ...
        x = function(t, n) {
          ...
          n))
            this.options[o] = n[o];
          if (
            (h(v, this.options.jsClass),
            (this.wrapperEl = t.replace("#", "")),
            e.getElementById(this.wrapperEl))
          )
        ...
        (x.prototype = {
          destroy: function() {
            this._removeStyles(),
              ...
              p(i, "opened"),
              p(i, s.navClass),
              p(i, s.navClass + "-" + this.index),
              p(v, s.navActiveClass),
              i.removeAttribute("style"),
              i.removeAttribute("aria-hidden"),
              d(t, "resize", this, !1),
              d(t, "focus", this, !1),
              d(e.body, "touchmove", this, !1),
          ...
          toggle: function() {
            !0 === c && (f ? this.close() : this.open());
          },
          open: function() {
            f ||
              (p(i, "closed"),
              h(i, "opened"),
              h(v, s.navActiveClass),
              h(a, "active"),
              (i.style.position = s.openPos),
              m(i, { "aria-hidden": "false" }),
              (f = !0),
              s.open());
          },
          close: function() {
          ...
          resize: function() {
            "none" !== t.getComputedStyle(a, null).getPropertyValue("display")
              ? ((l = !0),
                m(a, { "aria-hidden": "false" }),
                i.className.match(/(^|\s)closed(\s|$)/) &&
                  (m(i, { "aria-hidden": "true" }),
                  (i.style.position = "absolute")),
                this._createStyles(),
                this._calcHeight())
              : ((l = !1),
                m(a, { "aria-hidden": "true" }),
                m(i, { "aria-hidden": "false" }),
                (i.style.position = s.openPos),
                this._removeStyles());
          },
          ...
          _createStyles: function() {
            g.parentNode ||
              ((g.type = "text/css"),
              e.getElementsByTagName("head")[0].appendChild(g));
          },
          ...
          _createToggle: function() {
            if (s.customToggle) {
              ...
              if (e.getElementById(t)) a = e.getElementById(t);
              else {
          ...
          _closeOnNavClick: function() {
            if (s.closeOnNavClick) {
              var e = i.getElementsByTagName("a"),
                t = this;
              !(function(e, t, n) {
          ...
          _calcHeight: function() {
            for (var e = 0, t = 0; t < i.inner.length; t++)
              e += i.inner[t].offsetHeight;
            var n =
              "." +
              s.jsClass +
              " ." +
            ...
            g.styleSheet ? (g.styleSheet.cssText = n) : (g.innerHTML = n),
              (n = "");
          }
        }),
        new x(o, r)
